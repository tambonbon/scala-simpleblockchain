...
import blockchain.Chain.{ChainLink, EmptyChain}
...
object JsonSupplement extends DefaultJsonProtocol {
    ...
    implicit object TransactionJsonFormat extends RootJsonFormat[Transaction] {
        ...
        def read(value: JsValue) = {
            value.asJsObject.getFields("sender", "recipient", "value") match {
                ...
                case _ => throw new DeserializationException("blockchain.Transaction expected")
            }
        }
    }
